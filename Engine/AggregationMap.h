...
public:
	...
	void buildBaseToParentMap_AllToOne(const Set* elems, map<IdentifierType, size_t>* factors);
	void buildBaseToParentMap_OneByOne(const Set* elems);
...
public:
	...
	class Iterator  : public std::iterator<std::forward_iterator_tag, IdentifierType, ptrdiff_t, IdentifierType *, IdentifierType &> {
	public:
