...
#ifndef STOAP_COLLECTIONS_STRINGBUFFER_H_
#define STOAP_COLLECTIONS_STRINGBUFFER_H_ 1
...
struct StringBuffer {
  ...
  void copy(const StringBuffer& cpy) {
    replaceText(cpy.c_str(), cpy.length());
  }
...
#define ESCAPE_URI_CHAR(c, s) case (c): memcpy(bufferPtr, (s), 3); bufferPtr+=3; break;
  void appendURIComponentText(const char * str) {
    size_t len = strlen(str);
    reserve(len * 3 + 1);
  ...
  void appendInteger2(uint32_t attr) {
    reserve(2);
    appendChar0(static_cast<char>( ((attr / 10L) % 10 + '0')));
    appendChar0(static_cast<char>( (attr % 10 + '0')));
    *bufferPtr = '\0';
  }
  ...
  void appendInteger4(uint32_t attr) {
    reserve(4);
    appendChar0(static_cast<char>((attr / 1000L) % 10 + '0'));
    appendChar0(static_cast<char>((attr / 100L) % 10 + '0'));
    appendChar0(static_cast<char>((attr / 10L) % 10 + '0'));
    appendChar0(static_cast<char>((attr % 10 + '0')));
    *bufferPtr = '\0';
  }
  ...
  void appendInteger(uint32_t attr) {
    ...
    if (1000000000L <= attr) {
      appendChar0(static_cast<char>((attr / 1000000000L) % 10 + '0'));
    }
    if (100000000L <= attr) {
      appendChar0(static_cast<char>((attr / 100000000L) % 10 + '0'));
    }
    if (10000000L <= attr) {
      appendChar0(static_cast<char>((attr / 10000000L) % 10 + '0'));
    }
    if (1000000L <= attr) {
      appendChar0(static_cast<char>((attr / 1000000L) % 10 + '0'));
    }
    if (100000L <= attr) {
      appendChar0(static_cast<char>((attr / 100000L) % 10 + '0'));
    }
    if (10000L <= attr) {
      appendChar0(static_cast<char>((attr / 10000L) % 10 + '0'));
    }
    if (1000L <= attr) {
      appendChar0(static_cast<char>((attr / 1000L) % 10 + '0'));
    }
  ...
  void appendInteger(uint64_t attr) {
    ...
    if (10000000000000000000ULL <= attr) {
      appendChar0(static_cast<char>((attr / 10000000000000000000ULL) % 10 + '0'));
    }
    if (1000000000000000000ULL <= attr) {
      appendChar0(static_cast<char>((attr / 1000000000000000000ULL) % 10 + '0'));
    }
    if (100000000000000000ULL <= attr) {
      appendChar0(static_cast<char>((attr / 100000000000000000ULL) % 10 + '0'));
    }
    if (10000000000000000ULL <= attr) {
      appendChar0(static_cast<char>((attr / 10000000000000000ULL) % 10 + '0'));
    }
    if (1000000000000000ULL <= attr) {
      appendChar0(static_cast<char>((attr / 1000000000000000ULL) % 10 + '0'));
    }
    if (100000000000000ULL <= attr) {
      appendChar0(static_cast<char>((attr / 100000000000000ULL) % 10 + '0'));
    }
    if (10000000000000ULL <= attr) {
      appendChar0(static_cast<char>((attr / 10000000000000ULL) % 10 + '0'));
    }
    if (1000000000000ULL <= attr) {
      appendChar0(static_cast<char>((attr / 1000000000000ULL) % 10 + '0'));
    }
    if (100000000000ULL <= attr) {
      appendChar0(static_cast<char>((attr / 100000000000ULL) % 10 + '0'));
    }
    if (10000000000ULL <= attr) {
      appendChar0(static_cast<char>((attr / 10000000000ULL) % 10 + '0'));
    }
    if (1000000000ULL <= attr) {
      appendChar0(static_cast<char>((attr / 1000000000ULL) % 10 + '0'));
    }
    if (100000000ULL <= attr) {
      appendChar0(static_cast<char>((attr / 100000000ULL) % 10 + '0'));
    }
    if (10000000ULL <= attr) {
      appendChar0(static_cast<char>((attr / 10000000ULL) % 10 + '0'));
    }
    if (1000000ULL <= attr) {
      appendChar0(static_cast<char>((attr / 1000000ULL) % 10 + '0'));
    }
    if (100000ULL <= attr) {
      appendChar0(static_cast<char>((attr / 100000ULL) % 10 + '0'));
    }
    if (10000ULL <= attr) {
      appendChar0(static_cast<char>((attr / 10000ULL) % 10 + '0'));
    }
    if (1000ULL <= attr) {
      appendChar0(static_cast<char>((attr / 1000ULL) % 10 + '0'));
    }
    if (100ULL <= attr) {
      appendChar0(static_cast<char>((attr / 100ULL) % 10 + '0'));
    }
    if (10ULL <= attr) {
      appendChar0(static_cast<char>((attr / 10ULL) % 10 + '0'));
    }
  ...
  void appendInteger(int64_t attr) {
    ...
    if (1000000000000000000LL <= attr) {
      appendChar0(static_cast<char>((attr / 1000000000000000000LL) % 10 + '0'));
    }
    if (100000000000000000LL <= attr) {
      appendChar0(static_cast<char>((attr / 100000000000000000LL) % 10 + '0'));
    }
    if (10000000000000000LL <= attr) {
      appendChar0(static_cast<char>((attr / 10000000000000000LL) % 10 + '0'));
    }
    if (1000000000000000LL <= attr) {
      appendChar0(static_cast<char>((attr / 1000000000000000LL) % 10 + '0'));
    }
    if (100000000000000LL <= attr) {
      appendChar0(static_cast<char>((attr / 100000000000000LL) % 10 + '0'));
    }
    if (10000000000000LL <= attr) {
      appendChar0(static_cast<char>((attr / 10000000000000LL) % 10 + '0'));
    }
    if (1000000000000LL <= attr) {
      appendChar0(static_cast<char>((attr / 1000000000000LL) % 10 + '0'));
    }
    if (100000000000LL <= attr) {
      appendChar0(static_cast<char>((attr / 100000000000LL) % 10 + '0'));
    }
    if (10000000000LL <= attr) {
      appendChar0(static_cast<char>((attr / 10000000000LL) % 10 + '0'));
    }
    if (1000000000LL <= attr) {
      appendChar0(static_cast<char>((attr / 1000000000LL) % 10 + '0'));
    }
    if (100000000LL <= attr) {
      appendChar0(static_cast<char>((attr / 100000000LL) % 10 + '0'));
    }
    if (10000000LL <= attr) {
      appendChar0(static_cast<char>((attr / 10000000LL) % 10 + '0'));
    }
    if (1000000LL <= attr) {
      appendChar0(static_cast<char>((attr / 1000000LL) % 10 + '0'));
    }
    if (100000LL <= attr) {
      appendChar0(static_cast<char>((attr / 100000LL) % 10 + '0'));
    }
    if (10000LL <= attr) {
      appendChar0(static_cast<char>((attr / 10000LL) % 10 + '0'));
    }
    if (1000LL <= attr) {
      appendChar0(static_cast<char>((attr / 1000LL) % 10 + '0'));
    }
    if (100LL <= attr) {
      appendChar0(static_cast<char>((attr / 100LL) % 10 + '0'));
    }
    if (10LL <= attr) {
      appendChar0(static_cast<char>((attr / 10LL) % 10 + '0'));
    }
  ...
  void appendCsvString(const string& text) {
    // do not escape here, because some string
    // i.e. lists of identifier - have no special characters
    appendText(text);
    appendChar(';');
  }
...
#endif  // STOAP_COLLECTIONS_STRINGBUFFER_H_
